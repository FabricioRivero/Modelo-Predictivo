...
if __name__ == '__main__':
    ...
    # Ejemplo de como configurar la info de J1 para cada equipo:
    MATCHDAY_2_INFO = {
        # equipo: {j1_result, points, gd, group_position}
        # ACTUALIZAR con resultados reales de Jornada 1
        'Argentina':  {'j1_result': 'W', 'points': 3, 'gd': 2, 'group_position': 1},
        'France':     {'j1_result': 'W', 'points': 3, 'gd': 1, 'group_position': 1},
        'Spain':      {'j1_result': 'W', 'points': 3, 'gd': 3, 'group_position': 1},
        'Germany':    {'j1_result': 'W', 'points': 3, 'gd': 2, 'group_position': 1},
        'Brazil':     {'j1_result': 'D', 'points': 1, 'gd': 0, 'group_position': 2},
        'England':    {'j1_result': 'W', 'points': 3, 'gd': 2, 'group_position': 1},
        'Netherlands':{'j1_result': 'D', 'points': 1, 'gd': 0, 'group_position': 2},
        'Portugal':   {'j1_result': 'W', 'points': 3, 'gd': 1, 'group_position': 1},
        'Chile':      {'j1_result': 'L', 'points': 0, 'gd': -2, 'group_position': 4},
        'Denmark':    {'j1_result': 'L', 'points': 0, 'gd': -1, 'group_position': 4},
        'Japan':      {'j1_result': 'D', 'points': 1, 'gd': 0, 'group_position': 3},
        'Scotland':   {'j1_result': 'L', 'points': 0, 'gd': -2, 'group_position': 4},
        'Switzerland':{'j1_result': 'W', 'points': 3, 'gd': 1, 'group_position': 1},
        'Iran':       {'j1_result': 'L', 'points': 0, 'gd': -2, 'group_position': 4},
        'Ecuador':    {'j1_result': 'D', 'points': 1, 'gd': 0, 'group_position': 3},
        'South Korea':{'j1_result': 'L', 'points': 0, 'gd': -1, 'group_position': 3},
    }
